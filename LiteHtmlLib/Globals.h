...
typedef void(*DrawBackground_function)(litehtml::uint_ptr hdc, litehtml::background_repeat repeat, const litehtml::web_color& color, const litehtml::position& pos);
