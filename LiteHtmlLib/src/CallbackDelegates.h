...
typedef void(*DrawBackground_function)(litehtml::uint_ptr hdc, const litehtml::tchar_t* image, litehtml::background_repeat repeat, const litehtml::web_color& color, const litehtml::position& pos, const litehtml::border_radiuses& borderRadiuses, const litehtml::position& borderBox);
...
typedef int(*GetDefaultFontSize_function)();
